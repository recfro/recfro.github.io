...
people:
  ...
  - title: "Staff and Alumni"
    role: ""
    intro: "Kasin Fong - programmer installation artist, RA SCM MFA.<br>Anthon Zhang - programmer machine learning, RA SCM CS.<br>Marco Lok - designer installation artist, RA SCM BSC.<br><br>(alum) Suifang Zhou - undergrad student, now Northeastern HCI."
    url: ""
    image: "/assets/images/pages/Staff.jpg"

  - title: "Joining Us"
    role: ""
    intro: "Fully funded positions for motivated graduate students and researchers are available. Preference for open communicators across academic-artistic boundaries in one of: 1. interaction (HCI, HRI, performance), 2. creative tech (XR, EEG, 3D, installation, fashion tech), 3. computation (ML, CV, robotics), 4. neuropsychology (spatial interaction, implicit learning). Positions are competitive and limited to 1-2 per cycle. Email RAY with CV, see page below."
