...
people:
  ...
  - title: "Evan Yifan Zhao"
    role: "graduate student, city university of hong kong"
    intro: "Evan Yifan Zhao is a PhD student in HCI working with GenAI and immersive technologies. She received her BA in Cinematography and Production and New Media Art from the Communication University of China, and her MA in Film and Media Studies (Emergent Media) from Columbia University. Her research interests focus on death, dying, and mortality, and is published in CHI. She is currently exploring how immersive environments can represent near-death experiences and to design approaches for death education. Her work has been shown in Fringe Club Hong Kong, Chinese CHI, and Hong Kong Arts Centre."
    url: "https://scholars.cityu.edu.hk/en/persons/yzhao597"
    image: "/assets/images/pages/figs_evanzhao01.jpg"

  - title: "Linshi Li"
    role: "graduate student, city university of hong kong"
    intro: "Linshi Li is a PhD student in HCI at Studio for Narrative Spaces, whose research lies at the intersection of game design, generative AI, and psychology. She received her bachelor's degree in Digital Media Technology from Fuzhou University and the National University of Ireland, and her MA in Design from Goldsmiths, University of London. Her current research explores digital ownership and how games and generative AI can support socially beneficial behavioural change. Linshi enjoys travelling and sports, especially rowing and swimming. Her work has been published in ACM Interactive Design and Children."
    url: "https://linshili02.github.io"
    image: "/assets/images/pages/figs_linshilin01.jpg"

  - title: "Ruyan Chen"
    role: "graduate student, city university of hong kong"
    intro: "Ruyian Chen is a PhD student at Studio for Narrative Spaces, whose research explores the design of immersive and interactive cultural experiences at the intersection of extended reality, artificial intelligence, and digital heritage. He is currently exploring how cultural data can be transformed into meaningful, narrative-driven experiences that position visitors as protagonists. He holds a B.S. in Media, Culture, and Communication from New York University and an M.A. in Computational Media from Duke University. He enjoys playing table tennis and embraces a 'hasta el final' mindset."
    url: "https://chenruyan.com/"
    image: "/assets/images/pages/figs_ruyanchen01.jpg"

  - title: "Kexin Ren (Kasey)"
    role: "graduate student, city university of hong kong"
    intro: "Kexin is a PhD student at Studio for Narrative Spaces. She received her B.A. in Landscape Architecture from the Central Academy of Fine Arts and her M.A. in Information Art and Design from Tsinghua University. Prior to her PhD, she worked as a UX designer on mobile operating systems. Her research interests include HCI, games, spatial narratives, and communities of practicing creativity in virtual settings. In her free time, she enjoys nature and craft-making. Her research work has been published in ACM Multimedia, IEEE TVCG, etc."
    url: "https://wholesale-willow-b90.notion.site/kexin-s-portfolio"
    image: "/assets/images/pages/figs_kexinren01.jpg"
  ...
  - title: "Vyom Shankar"
    ...
    intro: "Vyom is an undergrad Creative Media student at the City University of Hong Kong, dedicated to exploring the intersection of storytelling, digital design, and interactive media. Vyom is working on games for creative writing and overcoming negative feedback, utilizing insights from psychology and serious game design. Outside of work, he enjoys tennis, video games, and film, and draws creative inspiration from traveling and exploring new narratives."
